...
@barbearias_blueprint.route('/barbearias', methods=['GET'])
def get_barbearias():
...
@barbearias_blueprint.route('/barbearias/<barbearia_id>', methods=['GET'])
def get_barbearia_por_id(barbearia_id):
    connection = get_db_connection()
...
@barbearias_blueprint.route('/barbearias', methods=['POST'])
...
@barbearias_blueprint.route('/barbearias/<barbearia_id>', methods=['PUT'])
...
@barbearias_blueprint.route('/barbearias/<barbearia_id>', methods=['DELETE'])
